...
Enjoy [PHP The Right Way](http://laravel-taiwan.github.io/php-the-right-way/) and want to get
...
The [issue tracker](https://github.com/laravel-taiwan/php-the-right-way/issues) is
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream https://github.com/laravel-taiwan/php-the-right-way.git
   ```
